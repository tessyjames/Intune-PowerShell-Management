...
$AuditCategories = Get-AuditCategories | Sort-Object

$Events = @()

foreach($AuditCategory in $AuditCategories){

    Write-Host "Checking Audit Category '$AuditCategory' for activity by $($User.userPrincipalName)..." -ForegroundColor Gray
